        ...
        <main className='mt-16 mx-auto max-w-7xl px-4 sm:mt-24'>
          <div className='text-center'>
            ...
            <p className='mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl'>
              Harnessing 50+ years of heritage and the highest quality
              local ingredients, we are commited to bringing you the
              best possible dining experience at one of our growing
              list of impressive concepts.
            </p>
