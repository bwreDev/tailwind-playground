...
export default function Example() {
	return (
		<div className='relative bg-warm-gray-600 py-16 sm:py-24 lg:py-32'>
			<div className='mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl'>
				<p className='mt-2 text-3xl font-extrabold text-warm-gray-900 tracking-tight sm:text-4xl'>
					Come Visit Us
				</p>
				<p className='mt-5 max-w-prose mx-auto text-xl text-warm-gray-200'>
					Each of our Central Coast locations are dedicated to providing
					excellent food and fantastic customer service.
				</p>
				<div className='mt-12'>
